...
class Soldier {
    ...
    public Soldier(String soldier_name, double h, double _x, double _y){
        ...
        HelloApplication.group.getChildren().addAll(name, life, isoldier);
    ...
    public void delete(){
        HelloApplication.group.getChildren().removeAll(name, life, isoldier);
...
public class HelloApplication extends Application {
    public static void DeleteUnit(int index){
    ...
    public void start(Stage stage) throws IOException {
        imsoldier = new Image(HelloApplication.class.getResource("Unit.png").toString(), 140, 200, false, false);
        System.out.println(HelloApplication.class.getResource("Unit.png").toString());
 ;
